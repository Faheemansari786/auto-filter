...
PICS_URL = (environ.get('PICS', 'https://ibb.co/TMHpMqD7')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://ibb.co/TMHpMqD7')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1321078922').split()] # Replace with the actual admin ID(s) to add
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://naheem:naheem@cluster0.e0vr3lj.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
if HAS_SSL:
    URL = "https://evil-fina-faheem-d620f6e2.koyeb.app/".format(FQDN)
else:
    URL = "https://evil-fina-faheem-d620f6e2.koyeb.app/".format(FQDN)
